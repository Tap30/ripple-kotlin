...
class ConsoleLoggerAdapter(
    private val level: com.tapsioss.ripple.core.adapters.LogLevel = com.tapsioss.ripple.core.adapters.LogLevel.WARN
) : LoggerAdapter {
    
    override fun debug(message: String, vararg args: Any?) {
        if (level <= com.tapsioss.ripple.core.adapters.LogLevel.DEBUG) {
            println("[DEBUG] Ripple: $message")
        }
    }
    
    override fun info(message: String, vararg args: Any?) {
        if (level <= com.tapsioss.ripple.core.adapters.LogLevel.INFO) {
            println("[INFO] Ripple: $message")
        }
    }
    
    override fun warn(message: String, vararg args: Any?) {
        if (level <= com.tapsioss.ripple.core.adapters.LogLevel.WARN) {
            println("[WARN] Ripple: $message")
        }
    }
    
    override fun error(message: String, vararg args: Any?) {
        if (level <= com.tapsioss.ripple.core.adapters.LogLevel.ERROR) {
